  ...
  return (
    <html lang="en">
      <body className={"w-screen h-screen flex justify-center sm:p-10"}>
        <div
          className={
            "container max-w-screen-lg min-h-full flex flex-col sm:flex-row sm:rounded-lg border border-gray-300"
          }
        >
          ...
          <main
            className={
              "flex-grow bg-gray-100 border-t sm:border-t-0 sm:border-l border-gray-300 p-4 sm:rounded-l-none sm:rounded-r-lg overflow-scroll"
            }
          >
            {children}
          </main>
